...
#define BP_6_Pin GPIO_PIN_0
#define BP_6_GPIO_Port GPIOA
#define BP_10_Pin GPIO_PIN_1
#define BP_10_GPIO_Port GPIOA
#define BP_5_Pin GPIO_PIN_2
#define BP_5_GPIO_Port GPIOA
#define BP_1_Pin GPIO_PIN_3
#define BP_1_GPIO_Port GPIOA
#define BP_0_Pin GPIO_PIN_4
#define BP_0_GPIO_Port GPIOA
#define BP_4_Pin GPIO_PIN_5
#define BP_4_GPIO_Port GPIOA
#define BP_9_Pin GPIO_PIN_6
#define BP_9_GPIO_Port GPIOA
#define BP_8_Pin GPIO_PIN_7
#define BP_8_GPIO_Port GPIOA
...
#define BP_2_Pin GPIO_PIN_4
#define BP_2_GPIO_Port GPIOB
#define BP_7_Pin GPIO_PIN_5
#define BP_7_GPIO_Port GPIOB
#define BP_12_Pin GPIO_PIN_6
#define BP_12_GPIO_Port GPIOB
#define BP_3_Pin GPIO_PIN_7
#define BP_3_GPIO_Port GPIOB
